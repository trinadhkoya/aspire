...
const initialState = {
  ...
  cardCVV: null, //Card CVV as Received from API
  ...
  weeklySpendingLimit: null, //as Received from API, null signifies no spending limit has been set.
...
export const debitCardSlice = createSlice({
  ...
  reducers: {
    setCompleteCardDetails: (state, action) => {
      ...
      state.weeklySpendingLimitExhausted =
        action.payload.weeklySpendingLimitExhausted;
    },
...
export const selectCardNumberVisible = state =>
  state.debitCard.cardNumberVisible;
...
export const selectWeeklySpendingLimit = state =>
  state.debitCard.weeklySpendingLimit;
export const selectWeeklySpendingLimitExhausted = state =>
  state.debitCard.weeklySpendingLimitExhausted;
